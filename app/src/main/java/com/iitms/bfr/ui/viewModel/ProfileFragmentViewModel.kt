...
import com.iitms.bfr.data.repository.ProfileRepository
...
class ProfileFragmentViewModel @Inject constructor(var repository: ProfileRepository) : BaseViewModel(){
